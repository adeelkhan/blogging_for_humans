...
"""
Blogging-for-Humans documentation build configuration file.
...
project = 'Blogging-for-Humans'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Blogging-for-Humans'
...
#
# html_title = 'Blogging-for-Humans v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'A sample Django package',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'blogging_for_humans'),
                os.path.join(root_path, 'blogging_for_humans/migrations')])
