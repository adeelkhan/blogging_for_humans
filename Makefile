...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd blogging-for-humans && ../manage.py makemessages -l en -v1 -d django
	cd blogging-for-humans && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd blogging-for-humans && ../manage.py compilemessages

detect_changed_source_translations:
	cd blogging-for-humans && i18n_tool changed
...
dummy_translations: ## generate dummy translation (.po) files
	cd blogging_for_humans && i18n_tool dummy
